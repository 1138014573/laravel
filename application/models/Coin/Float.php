...
class Coin_FloatModel extends Orm_Base{
	...
	public $field = array(
		...
		'price_float' => array('type' => "decimal(8,4)", 'comment' => '价格浮动'),
		'price_close' => array('type' => "decimal(8,4)", 'comment' => '收盘价'),
		'percent' => array('type' => "decimal(8,4)", 'comment' => '涨跌幅'),
        'price_up' => array('type'=>"decimal(8,4)", 'comment'=>'涨停价'),
        'price_down' => array('type'=>"decimal(8,4)", 'comment'=>'跌停价'),
