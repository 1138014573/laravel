		...
		<div class="wrap">
			<div class="box">
				...
				<div class="loginBox">
					<form id="form" method="post" onsubmit="return modifyDo();" class="modifyLeft" enctype="multipart/form-data">
                        ...
                        <span class="show_text"><?php echo  substr_replace($data[0]['name'],'***','3');?></span>
						...
						<div class="login">
							<div class="clear">
                                ...
                                <span class="show_text"><?php echo substr_replace($data[0]['idcard'],'******','2','10');?></span>
            ...
            <div class="login">
              <div class="clear">
                ...
                <span class="show_text"><?php if($data[0]['status']==2){
						echo '已认证';
                ...
                <!-- <input type="text" value="<?php  if(isset($data['mo'])) echo $data['mo'] ?>" id="mo" name="mo" class="loginValue" placeholder="必须填写自己真实的手机号码"> -->
						...
						<div class="auth_pic">
							<div class="img_container">
								<img src="<?php echo str_replace('../public','',$data[0]['frontFace'])?>">
								<img src="<?php echo str_replace('../public','',$data[0]['backFace'])?>">
								<img src="<?php echo str_replace('../public','',$data[0]['handkeep'])?>">
							</div>
