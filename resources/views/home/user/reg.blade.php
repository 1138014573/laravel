...
<div class="login_wrap display_c" id="reg_now" <?php if(isset($posttype) && $posttype == 1){?>style="display: block;"<?php }?>>
	<div class="login_con register_con">
		...
		<form class="register_form"  id="form" method="post" onsubmit="return signupDo();" style="margin: 10px 0 0 0;">
			...
			<input type="hidden" value="emailreg" name="emailreg">
		...
		<form class="register_form"  id="form2" method="post" onsubmit="return signupDoPhone();" style="margin: 10px 0 0 0; display: none;">
			...
			<div class="login_list lg_veri">
				...
				<img id="captchaimg2" src="/index/captcha?t=<?php  echo rand(100000, 999999)?>">
			</div>
			<div class="login_list lg_veri">
				<em></em>
...
<script>
	...
	function signupDoPhone(){
		...
		// var html = $.ajax({type: "get", url: '/ajax/user/phone/' + encodeURIComponent($('#phone').val()), async: false,
		// }).responseText;
