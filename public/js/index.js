...
var widthNumArr = {'goc':0.05, 'btc':10, 'ltc':0.1, 'lc': 0.005, 'lsk':0.005, 'eth':0.5, 'etc':0.2, 'mtc':0.002, 'uc': 0.01, 'lbc': 0.002, 'dsc': 0.002, 'lcc': 0.002, 'mac': 0.002,'tur':0.002, 'ecf':0.002, 'osc':0.002, 'gec':0.002};
...
function btcorder(limit,coin,display,price_float,number_float){
	$.get('/json/'+coin+'_order', function(d){
		...
		document.title = display+d.d[0].p+" | 交易中心-币交所-数字货币交易平台";
